...
- Lower Cost and Resource Requirements:
    Running a prompt is less resource-intensive than fine-tuning a #abbr.a[LLM] @PORNPRASIT2024107523 @shin2025promptengineeringfinetuningempirical.
...
We observed that few-shot with reflection & prompt decomposition achieved the best accuracy, while techniques such as few-shot and CoT achieve a 75% accuracy on our evaluation dataset.
https://medium.com/@fhuthmacher/beyond-rule-based-data-quality-exploring-llm-powered-anomaly-detection-9a0c7c98c690